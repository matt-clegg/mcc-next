...
const selectedAsset = defineModel<string>();
...
<template>
  <div class="space-y-4">
    ...
    <div class="sm:h-[600px] overflow-y-auto px-3 py-1 sm:py-4 sm:px-5">
      <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-2 sm:gap-3">
        ...
        >
          <AssetPreview
              :selected="!!selectedAsset && selectedAsset === asset.id"
              :asset="asset"
              @select="onSelect"
          />
        </div>
